namespace MyONez.Base.Screens
{
    ...
    using MyONez.Base.AdditionalStuff.Effects;
    ...
    public class EffectsScene : BaseScene
    {
        ...
        public IEnumerable<Effect> GetEffects()
        {
            ...
            heatDistortionEffect.DistortionTexture = this.Content.Load<Texture2D>(ContentPaths.Textures.heatDistortionNoise);
            ...
            textureWipeEffect.Texture = this.Content.Load<Texture2D>(ContentPaths.Textures.TextureWipeTransition.angular);
